...
namespace CombatMoves.ScriptableObjects.BaseClasses
{
    public abstract class AbstractCombatMove : ScriptableObject
    {
        ...
        [field: SerializeField] public float Potency { get; protected set; } = 10;

        [field: SerializeField] public ValidTargets ValidTargets { get; protected set; } = ValidTargets.OpposingTeam;
