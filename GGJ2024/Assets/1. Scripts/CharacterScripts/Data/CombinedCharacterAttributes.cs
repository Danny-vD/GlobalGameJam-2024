...
namespace CharacterScripts.Data
{
    ...
    {
        private readonly List<CharacterAttributes> accumulatedAttributesList = new();
        ...
        public override float SpecialAttackPower =>
            accumulatedAttributesList.Sum(attributes => attributes.SpecialAttackPower);
        ...
        /// <summary>
        ///     Removes the provided attributes from the list of attributes to add together when getting an attribute from this
        ///     instance
        /// </summary>
        ...
        /// <summary>
        ///     Getting the individual attributes one by one is very inefficient, use this function instead if you need multiple at
        ///     once
        /// </summary>
