...
namespace APIs.DiscordIntegrationPackage.Factories
{
    public static class ActivityFactory
    {
        ...
        {
            if (!showElapsedTime) return CreateActivity(details, state);
        ...
        public static Activity CreateActivity(string details, string state, bool showRemainingTime,
            long secondsRemaining)
        {
            if (!showRemainingTime) return CreateActivity(details, state);
        ...
        public static Activity CreateActivity(string details, string state, bool showRemainingTime,
            long secondsRemaining, DiscordImage largeImage)
        {
        ...
        public static Activity CreateActivity(string details, string state, bool showRemainingTime,
            long secondsRemaining, DiscordImage largeImage, DiscordImage smallImage)
        {
        ...
        //              MULTIPLAYER
        //\\//\\//\\//\\//\\//\\//\\//\\//\\//\\
        public static Activity CreateMultiplayerActivity(string state, string partyID,
        ...
        public static Activity CreateMultiplayerActivity(string state, DiscordImage largeImage, DiscordImage smallImage,
        ...
        public static Activity CreateMultiplayerActivity(string details, string state, bool showElapsedTime,
            string partyID, ActivityPartyPrivacy partyPrivacy, int currentPartySize, int maxPartySize,
            ActivitySecrets activitySecrets)
        {
        ...
        public static Activity CreateMultiplayerActivity(string details, string state, bool showRemainingTime,
            long secondsRemaining,
            string partyID, ActivityPartyPrivacy partyPrivacy, int currentPartySize, int maxPartySize,
            ActivitySecrets activitySecrets)
        {
        ...
        //              PRIVATE UTILITY
        //\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//\\//
        private static void AddMultiplayerInformation(ref Activity activity, string partyID,
            ActivityPartyPrivacy partyPrivacy, int currentPartySize, int maxPartySize, ActivitySecrets activitySecrets)
        {
