...
namespace LocalisationPackage.Core.IO.Parsers
{
    ...
    public class JsonLanguageVariables
    {
        ...
        public List<LanguageVariable> Variables = new();

        private Dictionary<string, Dictionary<string, string>> entryPerVariable;
    ...
    public static class CalculateLanguageDictionary
    {
        ...
        public static Dictionary<string, Dictionary<string, string>> GetNestedDictionary(
            IEnumerable<LanguageVariable> pArray)
        {
