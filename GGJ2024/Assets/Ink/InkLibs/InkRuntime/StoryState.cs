...
namespace Ink.Runtime
{
    ...
    public class StoryState
    {
                        ...
                        else
                        {
                            ...
                            if (controlCommand != null)
                            {
                                if (controlCommand.commandType == ControlCommand.CommandType.BeginTag)
                                    inTag = true;
                                else if (controlCommand.commandType == ControlCommand.CommandType.EndTag) inTag = false;
                            }
                        }
                    }
                ...
                if (_outputStreamTagsDirty)
                {
                    ...
                    foreach (var outputObj in outputStream)
                    {
                        ...
                        else if (inTag)
                        {
                            ...
                            if (strVal != null) sb.Append(strVal.value);
                        }
        ...
        public bool currentFlowIsDefaultFlow => _currentFlow.name == kDefaultFlowName;
        ...
        public List<string> aliveFlowNames
        {
            get
            {
                if (_aliveFlowNamesDirty)
                {
                    ...
                    if (_namedFlows != null)
                        foreach (var flowName in _namedFlows.Keys)
            ...
            if (arguments != null)
                for (var i = 0; i < arguments.Length; i++)
                {
                    if (!(arguments[i] is int || arguments[i] is float || arguments[i] is string ||
                          arguments[i] is bool || arguments[i] is InkList))
