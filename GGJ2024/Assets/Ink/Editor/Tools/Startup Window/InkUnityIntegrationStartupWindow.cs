...
namespace Ink.UnityIntegration
{
    ...
    public class InkUnityIntegrationStartupWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.BeginVertical();
            EditorGUILayout.LabelField(new GUIContent(InkEditorUtils.inkLogoIcon), GUILayout.Width(areaSize.x),
                GUILayout.Height(areaSize.x *
                                 ((float)InkEditorUtils.inkLogoIcon.height / InkEditorUtils.inkLogoIcon.width)));
            GUILayout.Space(5);
...

            {
                ...
                if (GUILayout.Button("Discord Community+Support")) Application.OpenURL("https://discord.gg/inkle");
