...
namespace Ink.UnityIntegration
{
    ...
    public class InkFile
    {
        ...
        public bool isMarkedToCompileAsMasterFile =>
            InkSettings.instance.includeFilesToCompileAsMasterFiles.Contains(inkAsset);
        ...
        public string jsonPath
        {
            get
            {
                ...
                Debug.Assert(!string.IsNullOrEmpty(_filePath),
                    "File path for ink file is null! The ink library requires rebuilding. Asset: " + inkAsset);
                ...
                Debug.Assert(jsonFolder != null,
                    "JSON folder not found for ink file at path. File Path: " + _filePath + ". Asset: " + inkAsset);

                var jsonPath = AssetDatabase.GetAssetPath(jsonFolder);
                Debug.Assert(Directory.Exists(jsonPath),
                    "JSON folder path is not a directory! Json Path: " + jsonPath + ". Asset: " + inkAsset);
        ...
        public IEnumerable<InkFile> masterInkFilesIncludingSelf
        {
            get
            {
                ...
                foreach (var masterInkFile in masterInkFiles) yield return masterInkFile;
            }
        }
